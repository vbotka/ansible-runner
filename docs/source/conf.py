...
project = 'ansible-runner-role-doc'
...
htmlhelp_basename = 'ansible-runner-role'
...
latex_documents = [
    (master_doc, 'ansible-runner-role.tex', 'ansible-runner-role Documentation',
...
man_pages = [
    (master_doc, 'ansible-runner-role', 'ansible-runner-role Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ansible-runner-role', 'ansible-runner-role Documentation',
     author, 'ansible-runner-role', 'One line description of project.',
     'Miscellaneous'),
]
