...
.. warning::
   ...
   By default, *ar_pkg_install*, *ar_pip_install*, and
   *ar_venv_install* are mutually exclusive. Disable
   *ar_sanity_pip_exclusive* if you want to install more options in
   the same play.
